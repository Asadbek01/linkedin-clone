            ...
            <Row className='pl-3 mb-2 justify-content-between mr-3 mt-2'>
                <div className="d-flex w-75">
                    ...
                    <div className="d-flex flex-column w-75 ml-2">
                        ...
                        <p className='text-muted mb-0'>{diffInM < 60 ? diffInM + 'm' : diffInH < 24 ? diffInH + 'h' : diffInD < 7 ? diffInD + 'd' : diffInW  < 4 ? diffInW + 'w' : diffInMo + 'mo'} &#8226; <i className='bi bi-globe2'></i></p>
                    </div>
                </div>
